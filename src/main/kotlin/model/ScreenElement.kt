...
data class ScreenElement(
    ...
    private fun String.replaceVariables(
        ...
        androidComponentBaseClass: String
    ) =
        replace(Variable.NAME.value, screenName)
            ...
            .replace(
                Variable.ANDROID_COMPONENT_CLASS_NAME.value,
                androidComponentBaseClass.substring(androidComponentBaseClass.lastIndexOf(".") + 1)
            )
